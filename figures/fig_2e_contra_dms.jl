...
neural_vals = contra_dms.cm[xt, dms_wcidx]
beh_vals = contra_dms.beh[xt, dms_wcidx]
...
plt.savefig("contra_dms_beh_neu_cor_v4.pdf", bbox_inches="tight", transparent=true)