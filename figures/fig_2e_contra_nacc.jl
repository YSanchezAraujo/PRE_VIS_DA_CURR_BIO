...
xt = 1:20 # days
neural_vals = contra_nacc.cm[xt, nacc_wcidx]
beh_vals = contra_nacc.beh[xt, nacc_wcidx]
...
plt.savefig("contra_nacc_beh_neu_cor_v4.pdf", bbox_inches="tight", transparent=true)
