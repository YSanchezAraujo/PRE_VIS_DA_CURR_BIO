...
neural_vals = contra_dls.cm[xt, dls_wcidx]
beh_vals = contra_dls.beh[xt, dls_wcidx]
...
plt.savefig("contra_dls_beh_neu_cor_v4.pdf", bbox_inches="tight", transparent=true)